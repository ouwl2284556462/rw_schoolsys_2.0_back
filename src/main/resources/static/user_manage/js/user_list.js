$(function(){
	...
	$("#user-list-addUserBtn").click(user_list_onAddUserBtnClick);
...
function user_list_onAddUserBtnClick(){
	var url = $("#user-list-addUserBtn").data("target-url");
	var param = {};
	param.submitBtnId = "user-list-addUserBtn";
